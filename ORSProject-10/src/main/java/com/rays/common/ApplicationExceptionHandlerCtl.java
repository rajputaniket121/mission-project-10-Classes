 ...
 * Provides centralized exception handling for database connectivity issues
...
public class ApplicationExceptionHandlerCtl {
     ...
     * @return ResponseEntity containing ORSResponse with a user-friendly error message
     *         and HTTP 503 SERVICE_UNAVAILABLE status
     */
    ...
    /**
     * Handles all other runtime exceptions that are not specifically handled
     * by other exception handlers.
     * 
     * @param e the runtime exception that was thrown
     * @return ResponseEntity containing ORSResponse with the exception message
     *         and HTTP 500 INTERNAL_SERVER_ERROR status
     */
