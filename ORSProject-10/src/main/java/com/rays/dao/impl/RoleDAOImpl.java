...
/**
 * Implementation of RoleDAOInt interface. Provides database operations for
 * managing role information with dynamic search criteria.
 * 
...
public class RoleDAOImpl extends BaseDAOImpl<RoleDTO> implements RoleDAOInt {
	...
	/**
	 * Builds WHERE clause predicates for role search criteria. Supports searching
	 * by ID and name.
	 * 
